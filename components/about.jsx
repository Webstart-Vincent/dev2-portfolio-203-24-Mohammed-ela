...
const About = () => {
  ...
  useEffect(() => {
    ...
    }, 3500); // Change le titre toutes les 3.5 secondes
  ...
  return (
    <section name="accueil" className="h-full pt-12 pb-20 sm:pb-10 sm:px-10">
      <div className="flex flex-col items-center justify-center px-10">
        ...
        <div className="grid justify-between gap-4 lg:grid-cols-[1fr_300px] items-center">
          <p className='text-gray sm:text-justify lg:py-20 lg:leading-relaxed hidden lg:block'>
